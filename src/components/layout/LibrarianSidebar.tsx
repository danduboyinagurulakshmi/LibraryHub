import { BookOpen, LayoutDashboard, Library, Users, BookPlus, ClipboardList, LogOut, BarChart3, MapPin } from "lucide-react";
...
const navItems = [
  ...
  { id: "books", label: "Manage Books", icon: Library },
...
const LibrarianSidebar = ({ activeTab, onTabChange }: LibrarianSidebarProps) => {
    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-sidebar text-sidebar-foreground flex flex-col">
      <div className="flex items-center gap-3 px-6 py-6 border-b border-sidebar-border">
        ...
        <div>
          ...
          <p className="text-xs text-sidebar-foreground/60">Librarian Panel</p>
        </div>
      </div>
      ...
      <div className="px-3 pb-3">
        <div className="p-4 rounded-lg bg-sidebar-accent mb-3">
          <p className="text-sm font-medium text-sidebar-foreground">{currentUser?.name || "Librarian"}</p>
